...
set output_srl=%output_path%\%~n1.reverse%~x1
set output_pro=%output_path%\%~n1.property
...
echo %~nx1を逆マスタリングします。
echo.
%mastering_tool% %input_srl% %output_srl% -i %mastering_ini% -p %output_pro% -r
