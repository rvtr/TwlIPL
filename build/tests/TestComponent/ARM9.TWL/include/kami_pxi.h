...
KAMIResult kamiCodecIo(u8 page, u8 reg_no, u8* buffer, u8 value, BOOL is_read);
...
static KAMIResult kamiCodecRead(u8 page, u8 reg_no, u8* buffer)
{
	return kamiCodecIo(page, reg_no, buffer, 0, TRUE);
}

static KAMIResult kamiCodecWrite(u8 page, u8 reg_no, u8 value)
{	
	return kamiCodecIo(page, reg_no, NULL, value, FALSE);
}
